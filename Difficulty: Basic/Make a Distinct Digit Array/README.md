<h2><a href="https://www.geeksforgeeks.org/problems/make-a-distinct-digit-array2007/1?page=1&company=Amazon,Microsoft,Flipkart,Google,Adobe,Samsung,Accolite,MakeMyTrip,Zoho,Snapdeal,Paytm,Morgan%20Stanley,Walmart,Goldman%20Sachs,OYO%20Rooms,Facebook,Wipro,Uber,TCS,Accenture,Infosys,Atlassian,Media.net,Cognizant&sortBy=difficulty">Make a Distinct Digit Array</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an array <strong>nums</strong> of positive integers of size <strong>N</strong>. Find&nbsp;all distinct digits present in <strong>nums</strong>.</span><br>&nbsp;</p>
